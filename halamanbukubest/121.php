    ...
    <form action="../checkoutupload.php" method="POST">
        <div class="container-item-detail">
            <div class="sub-container-1">
                <a href="../Daftarbuku/BestSeller/NeeNein.png"><img id="imagePreview" src="../Daftarbuku/BestSeller/NeeNein.png" alt="Gambar" name="gambar"></a>
            </div>
            <div class="sub-container-2">
                <h1 id="judulPreview" name="judul">sada</h1>
                <hr>
                <div class="rating">
                    <span>&#9733;</span>
                    <span>&#9733;</span>
                ...
                <p id="pengarang" name="pengarang">asdsad</p>
                <p id="harga" name="harga">1231231</p>
                <p name="note">no hidden cost</p>
            </div>
            <div class="sub-container">
                <!-- Kode lainnya ... -->
                <input type="hidden" name="imageUrl" value="../Daftarbuku/BestSeller/NeeNein.png" id="imageUrlInput">
                <input type="hidden" name="judul" value="sada" id="judulInput">
                <input type="hidden" name="pengarang" value="asdsad" id="pengarangInput">
