  ...
  <form action="../checkoutupload.php" method="POST">
    <div class="container-item-detail">
      <div class="sub-container-1">
            <a href="../Daftarbuku/BestSeller/Sertifikat-ML-MT-Compete.jpg"><img id="imagePreview"  src="../Daftarbuku/BestSeller/Sertifikat-ML-MT-Compete.jpg" alt="Gambar" name="gambar"></a>
      </div>
