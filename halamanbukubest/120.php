    ...
    <form action="../checkoutupload.php" method="POST">
        <div class="container-item-detail">
            <div class="sub-container-1">
                <a href="../Daftarbuku/BestSeller/2023-01-06-10-18-09_0.png"><img id="imagePreview" src="../Daftarbuku/BestSeller/2023-01-06-10-18-09_0.png" alt="Gambar" name="gambar"></a>
            </div>
            <div class="sub-container-2">
                ...
                <p id="pengarang" name="pengarang">asdas</p>
                <p id="harga" name="harga">500000</p>
                <p name="note">no hidden cost</p>
            </div>
            <div class="sub-container">
                <!-- Kode lainnya ... -->
                <input type="hidden" name="imageUrl" value="../Daftarbuku/BestSeller/2023-01-06-10-18-09_0.png" id="imageUrlInput">
                <input type="hidden" name="judul" value="asda" id="judulInput">
                <input type="hidden" name="pengarang" value="asdas" id="pengarangInput">
