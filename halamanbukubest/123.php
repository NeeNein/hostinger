    ...
    <form action="../checkoutupload.php" method="POST">
        <div class="container-item-detail">
            <div class="sub-container-1">
                <a href="../Daftarbuku/BestSeller/anime-anime-girls-akame-ga-kill-sheele-hd-wallpaper-preview.jpg"><img id="imagePreview" src="../Daftarbuku/BestSeller/anime-anime-girls-akame-ga-kill-sheele-hd-wallpaper-preview.jpg" alt="Gambar" name="gambar"></a>
            </div>
            <div class="sub-container-2">
                <h1 id="judulPreview" name="judul">Abdul </h1>
                <hr>
                <div class="rating">
                    <span>&#9733;</span>
                    <span>&#9733;</span>
                ...
                <p id="pengarang" name="pengarang">Basith</p>
                <p id="harga" name="harga">1231231</p>
                <p name="note">no hidden cost</p>
            </div>
            <div class="sub-container">
                <!-- Kode lainnya ... -->
                <input type="hidden" name="imageUrl" value="../Daftarbuku/BestSeller/anime-anime-girls-akame-ga-kill-sheele-hd-wallpaper-preview.jpg" id="imageUrlInput">
                <input type="hidden" name="judul" value="Abdul " id="judulInput">
                <input type="hidden" name="pengarang" value="Basith" id="pengarangInput">
                <input type="hidden" name="harga" value="1231231" id="hargaInput">
