...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <form action="../checkoutupload.php" method="POST">
    <div class="container-item-detail">
      ...
      <?php
              // Menyertakan file koneksi database (ganti dengan detail koneksi Anda)
              include '../php/koneksi.php';

              
              // Query untuk mengambil data dari tabel 'books' (ganti dengan query Anda)
              $query = "SELECT image FROM books";
              ...
              if ($result) {
                  ...
                  // Menggabungkan data untuk membentuk jalur gambar
                  $imagePath = $row['image'];
              } else {
              ...
              ?>
           <a href="<?php echo $imagePath; ?>"><img id="imagePreview" src="<?php echo $imagePath; ?>" alt="Gambar" name="gambar"></a>
      </div>
      <div class="sub-container-2">
          <h1 id="judulPreview" name = "judul">tes</h1>
          <hr>
          <div class="rating">
            <span>&#9733;</span>
            <span>&#9733;</span>
          ...
          <p id="pengarang" name="pengarang">1231231</p>
  ...
  <div class="container-deksripsi">
    <h3>Deskripsi :</h3>
    <hr>
    <p style="overflow-wrap: break-word; word-wrap: break-word; word-break: break-all; max-width: 990px; display: inline-block;">APA</p>
  <!-- Akhir Modal -->
