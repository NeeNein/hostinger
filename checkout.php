...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <form action="checkoutupload.php" method="POST">
    <div class="container-item-detail">
      <div class="sub-container-1">
          <img id="imagePreview"  src="./Daftarbuku/1.jpg" alt="Gambar" name="gambar">
      </div>
      <div class="sub-container-2">
          <h1 id="judulPreview" name = "judul">Anata</h1>
          <hr>
          <div class="rating">
            <span>&#9733;</span>
            <span>&#9733;</span>
          ...
          <p id="pengarang" name="pengarang">Abdul Basith</p>
          <h2 id="harga" name="harga">Rp.180.000</h2>
  ...
  <div class="container-deksripsi">
    <h3>Deskripsi :</h3>
    <hr>
    <p style="overflow-wrap: break-word; word-wrap: break-word; word-break: break-all; max-width: 990px; display: inline-block;">Masalah hadir sebagai ujian bagi manusia untuk membawa perubahan nasib. Tidak ada manusia yang hidup tanpa memiliki masalah. Kita tidak dapat menghapus kata-kata yang terlanjur terucap ataupun menghapus tindakan yang terlanjur dilakukan. Karena itu, keduanya harus dipikirkan sebelum dilepaskan. twkowkowkokoa twkoakoweakoweakoekawoekaowekoawekaowekoawekoawekoawekoawkeoawkeoawkeoawkeoawkeoawkeoawkeoawkeoawkeoawkeoawkeoawkeoawkeoawkeoawkeoawkeoawkeoawkeoawkeoawkeoawkeoawkeoawkeoawkeoawkoeaw
