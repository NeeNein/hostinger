  ...
  <form action="checkoutupload.php" method="POST">
    <div class="container-item-detail">
      <div class="sub-container-1">
            <a href="../Daftarbuku/Promo/10.jpg"><img id="imagePreview"  src="../Daftarbuku/Promo/10.jpg" alt="Gambar" name="gambar"></a>
      </div>
      <div class="sub-container-2">
          <h1 id="judulPreview" name = "judul">Naruto</h1>
          <hr>
          <div class="rating">
            <span>&#9733;</span>
            <span>&#9733;</span>
          ...
          <p id="pengarang" name="pengarang">Masahi Kisimoto</p>
          <p id="harga" name="harga">200000</p>
      ...
      <div class="sub-container">
          ...
          <button type="submit" value="Upload" class="btn btn-checkout">
            Checkout
              ...
              <script>
                  // Mendapatkan elemen dengan id "harga"
                  var elemenHarga = document.getElementById("harga");

                  // Mendapatkan nilai dari elemen tersebut
                  var harga = parseInt(elemenHarga.innerHTML);

                  // Mengubah harga menjadi format mata uang dengan menambahkan "Rp." dan "."
                  var hargaFormatted = "Rp. " + harga.toLocaleString() + ".";

                  // Mengubah nilai dalam elemen menjadi harga yang diformat
                  elemenHarga.innerHTML = hargaFormatted;
              </script>
